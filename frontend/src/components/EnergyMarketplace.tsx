    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            {isConnected ? (
                <>
                    {!userRegion ? (
                        <div className="mb-6 p-4 bg-yellow-50 rounded-lg">
                            <h3 className="text-lg font-semibold mb-2 text-gray-700">Register Your Region</h3>
                        ...
                        <>
                            <div className="mb-6 p-4 bg-green-50 rounded-lg">
                                <h3 className="text-lg font-semibold mb-2 text-gray-700">Your Trading Region</h3>
                            ...
                            {!createOfferView ? (
                                <>
                                    <div className="flex justify-between items-center mb-4">
                                        <h3 className="text-lg font-semibold text-gray-700">Available Energy Offers</h3>
                                        <button
                                    ...
                                    {isLoading ? (
                                        ...
                                        <div className="text-center py-8">
                                            <p className="text-gray-500">No active energy offers in your region</p>
                                            <button
                                                onClick={() => setCreateOfferView(true)}
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-4">
                                        <h3 className="text-lg font-semibold text-gray-700">Create Energy Offer</h3>
                                        <button
                                    ...
                                    <form onSubmit={handleCreateOffer} className="space-y-4">
                                        ...
                                        <div>
                                            <label htmlFor="min-purchase" className="block text-gray-700 mb-2">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            />
                                            <label htmlFor="certified" className="ml-2 block text-gray-700">
                                    ...
                                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                                        ...
                                        <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                                            <div className="grid grid-cols-2 gap-2">
                                                ...
                                                <div className="text-gray-600">Available Energy:</div>
                                                <div>{selectedOffer.energyAmount} kWh</div>

                                                <div className="text-gray-600">Price per kWh:</div>
                                        ...
                                        <form onSubmit={handlePurchaseEnergy}>
                                            <div className="mb-4">
                                                <label htmlFor="purchase-amount" className="block text-gray-700 mb-2">
                                                    Purchase Amount (kWh)
                                                </label>
                                                <input
                                                    id="purchase-amount"
                ...
                <div className="text-center py-8">
                    <p className="text-gray-500 mb-4">Connect your wallet to access the energy marketplace</p>
                </div>
            )}
        </div>
    )
